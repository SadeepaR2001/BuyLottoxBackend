...
export declare class AdminController {
    ...
    createGrid(body: CreateGridDto): Promise<{
        message: string;
        grid: {
            id: string;
            ...
            openAt: Date;
            closeAt: Date;
            subTicketPrice: import("@prisma/client/runtime/library").Decimal;
            ...
            winningPool: import("@prisma/client/runtime/library").Decimal;
    ...
    setWinningNumber(id: string, body: {
        winningNumber: number;
    }): Promise<{
        winningPool: number;
        winningAmountPerSubTicket: number;
